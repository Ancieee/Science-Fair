...
scatterPlot <- gdpDataFinal %>% 
  ...
  geom_point(alpha=0.7, colour = "#83D483") + 
  labs(x = "GDP per capita", 
       y = "Life expectancy",
       title = "Life Expectancy compared to GDP per capita") +
  geom_hline(yintercept=0, linetype="dashed", color = "#83D483", size=0.5) +
  theme_classic()
